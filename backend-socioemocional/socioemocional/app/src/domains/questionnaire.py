...
class Questionnaire(DomainBase, Base):
    ...
    category = relationship("Category", back_populates="questionnaires")
    ...
    def __init__(self, title: str, description: str, status: QuestionnaireStatus, category_id: UUID, created_by_id: UUID):
        self.title = title
    ...
    def update(self, title: str, description: str, status: QuestionnaireStatus, category_id: UUID):
        self.title = title
        self.description = description
        self.status = status
        self.category_id = category_id