...
SECRET_KEY = 'django-insecure-am%ed_0j2!jznm#y)8+1)mu$mt%u$vq+syg9g61q85tg8lxc_='
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware' # Adicionando middleware do corsheaders
]
...
CORS_ALLOW_ORIGIN = [
    'http://localhost:8080' # Caso for hospedado, necessário colocar o domínio da aplicação web que ira consumir (Frontend) para liberar o cors
]

# CORS_ORIGIN_ALLOW_ALL = True # Para permitir o cors de todas as origens